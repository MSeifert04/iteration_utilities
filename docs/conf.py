...
# -*- coding: utf-8 -*-
#
# iteration_utilities documentation build configuration file, created by
...
with open('../setup.py') as f:
    for i in f.readlines():
        if i.startswith('version ='):
            ...
            version = i.split('version =')[1].strip().strip('\'\"')
            # The full version, including alpha/beta/rc tags.
            release = version
            break
    else:
        raise TypeError('cannot determine the version of the package.')
...
htmlhelp_basename = 'iteration_utilitiesdoc'
...
latex_documents = [
  (master_doc,
  'iteration_utilities.tex',
  'iteration\\_utilities Documentation',
   'Michael Seifert',
   'manual'),
]
...
man_pages = [
    (master_doc, 'iteration_utilities', 'iteration_utilities Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'iteration_utilities', 'iteration_utilities Documentation',
   author, 'iteration_utilities', 'One line description of project.',
   'Miscellaneous'),
]
